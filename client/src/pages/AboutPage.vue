...
const profiles = [
  ...
  { name: "Ryan", profileId: "6883b078a391ab1830bdc467" },
];
  ...
  <section class="bg-blur main-font">
    ...
    <div class="text-center container">
      <p class="px-5 fs-5 mt-4">
        This project was created primarily using vue and node. This website is
        the capstone project for the CodeWorks© Immersive Full Stack course.
        This "capstone" acts as a sort of final test to show off what we have
        learned so far.
      </p>
      <p class="px-5 fs-5 pt-3">
        The Framed website is a mobile-forward image sharing website directed at
        a 25+ age group, playing off of early 2000's nostalgia with the color
        scheme and background being examples of this. The functionality of the
        site is quite extensive.
      </p>
      <div class="fs-2 mb-3 mt-4 col-12">An App By:</div>
      <div
        v-for="FramedCreator in FramedCreators"
        :key="FramedCreator.profileId"
        class="mb-4"
      >
        <div class="d-flex align-items-center justify-content-center">
          <img :src="FramedCreator.picture" class="pfp" alt="" />
          <RouterLink
            :to="{ name: 'Profile', params: { profileId: FramedCreator.id } }"
          >
            <div class="ms-3 fs-2 fw-bold fancy-font">
              {{ FramedCreator.name }}
            </div>
          </RouterLink>
        </div>
